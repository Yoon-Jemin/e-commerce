...
public class ProductMapper {
    public Product toProduct(final ProductRequest request) {
    ...
    public ProductPurchaseResponse toProductPurchaseResponse(final Product product, final double quantity) {
